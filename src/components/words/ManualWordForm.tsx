...
/** The full, every-field word form — for when you want full control. */
    ...
    <Card>
      <form onSubmit={onSubmit} style={{ display: "flex", flexDirection: "column", gap: "var(--space-4)" }}>
        ...
        <div style={{ display: "flex", gap: "var(--space-2)" }}>
          <Button type="submit" disabled={submitting}>{submitting ? "Saving…" : "Save word"}</Button>
          <Button type="button" variant="ghost" onClick={() => router.push("/words")}>Cancel</Button>
        </div>
      </form>
    </Card>
  );
